                            ...
                            <div class="col-6 text-right">
                                ...
                                <div class="btn-group mr-2" role="group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="{{ route('mouvements.export.excel', array_merge(request()->query(), ['scope' => 'current'])) }}">
                                            <i class="fas fa-file-excel text-success"></i> Excel (.xlsx)
                                        </a>
                                        <a class="dropdown-item" href="{{ route('mouvements.export.pdf', array_merge(request()->query(), ['scope' => 'current'])) }}">
                                            <i class="fas fa-file-pdf text-danger"></i> PDF
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <h6 class="dropdown-header">Toutes les Données</h6>
                                        <a class="dropdown-item" href="{{ route('mouvements.export.excel', array_merge(request()->query(), ['scope' => 'all'])) }}">
                                            <i class="fas fa-file-excel text-success"></i> Excel Complet
                                        </a>
                                        <a class="dropdown-item" href="{{ route('mouvements.export.pdf', array_merge(request()->query(), ['scope' => 'all'])) }}">

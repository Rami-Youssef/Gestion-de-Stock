    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
        <div class="container-fluid">
            <div class="header-body">
                <div class="row">
                    <div class="col">
                        <h1 class="text-white mb-0">Modifier le Produit</h1>
                        <p class="text-white">Modifiez les détails du produit</p>
                    </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('produits.update', $produit) }}" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nom" id="input-nom" class="form-control form-control-alternative" placeholder="Nom du produit" value="{{ old('nom', $produit->nom) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-reference">Référence</label>
                                        <input type="text" name="reference" id="input-reference" class="form-control form-control-alternative" placeholder="Référence du produit" value="{{ old('reference', $produit->reference) }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-quantite">Quantité en stock</label>
                                        <input type="number" name="quantite" id="input-quantite" class="form-control form-control-alternative" placeholder="Quantité en stock" value="{{ old('quantite', $produit->quantite) }}" min="0" required>
                                        <small class="text-muted">Pour ajuster le stock, préférez utiliser l'onglet Mouvements de stock</small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
